...
{groups}
  ...
  <details class="lp__note">
    ...
    <ul>
      <li>本デモのデータはすべて架空であり、実在する顧客の情報は含まれていません。</li>
      <li>「根拠」ボタンから、回答の出典となる帳票を確認できます。</li>
      <li>S・O・Dおよびリスク評価はAIが確定せず、最終判断は担当者が行う設計です。</li>
      <li>帳票の実ファイルは <span class="mono">帳票サンプル</span> フォルダにあります。Excelで開いて並べて表示できます。</li>
      <li>顧客データを用いたデモが必要な場合は、社内担当者へ相談してください。</li>
    </ul>
  </details>
